...
if (response.ok) {
        ...
        window.location.href = './product.html'; // Redireciona para a página protegida após o login
      } else {
  ...
  cadastroButton.addEventListener('click', () => {
    window.location.href = './user.html'; // Redireciona para a página de cadastro
  });
});
